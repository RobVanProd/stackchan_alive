...
- Spark and Glow persona packs under `personas/`, with bridge prompt loading, firmware speech-line, earcon, behavior, and expression codegen, CI validation, and pack verification for the first swappable Character OS layer.
