...
- Real firmware Wi-Fi provisioning, TCP/WebSocket task integration, boot-time endpoint-store hookup, response sending, and PC/mobile owner failover evidence on the CoreS3.
