...
- The simulator proves bridge frame ordering, LAN text turns, speech-envelope handoff, binary TTS audio stream accounting, virtual CoreS3 input/display/speaker counters, power-cycle recovery, and timeout failure behavior. It does not replace real hardware evidence.
