...
$expectedFiles = @(
  ...
  @{ Path = "voice/rvc/RVC_AUDITION.html"; MinBytes = 1000; Type = "text/html" },
  @{ Path = "voice/rvc/stackchan_rvc_bright_robot.mp3"; MinBytes = 50000; Type = "audio/" },
  @{ Path = "voice/rvc/stackchan_rvc_thinking_neutral.mp3"; MinBytes = 50000; Type = "audio/" },
  @{ Path = "voice/rvc/stackchan_rvc_safety_neutral.mp3"; MinBytes = 50000; Type = "audio/" },
