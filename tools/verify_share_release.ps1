...
foreach ($pattern in @($Version, "Hardware validation is still pending", "No-hardware gates passed", "Hardware gates pending", "Consumer rollout", "GitHub Actions", "Speaker audio evidence", "Preflight Evidence", "No-hardware device preflight", "Pending Promotion Gates", "Do not mark this release consumer-ready", "display-only-flash", "servo-calibration", "mixed-mode-soak", "power-cycle-recovery", "target-speaker-audio-evidence", "hardware-evidence-verification", "production-voice-source", "completed AUDIO_REVIEW.md plus a real-device speaker recording under audio/", "Dependency Provenance", "Declared library deps", "Direct Git deps missing refs", "Resolved Git deps without SHA", "SCServo#ee6ee4a", "DEPENDENCIES.md", "dependency_lock.json", "stackchan_alive_preview.png", "stackchan_alive_expression_sheet.png", "stackchan_alive_preview.mp4", "stackchan_alive_speech_preview.gif", "Voice Samples", "Stackchan Spark Synth v4", "micro-prosody", "syllable gating", "electromechanical mask", "formant-like resonators", "sample-hold texture", "comb resonance", "light musical vocoder", "phrase-timed chirp/boop accents", "RVC Voice Auditions", "RVC Neutral", "RVC Warm Slow", "RVC Bright Robot", "RVC Spark Boops", "RVC High Character", "stackchan_rvc_neutral.wav", "stackchan_rvc_safety_neutral.wav", "eSpeak-NG", "setup_voice_tools.cmd", "RenderEspeakSamples", "Voice Review Checklist", "Voice Source Gate", "pending production source", "licensed or owned production voice required", "RVC Candidate Base", "candidate-pending-rights-review", "Weights.gg", "clyaxlb9b000eoiqywl68wcrc", "CA0BFE7A889D81532A449307057718BF83B343BD09D6B69CAF2DFB79450EF9AE", "voice_rvc_base.yaml", "voice_rvc_base_metadata.json", "Hardware Audio Evidence", "AUDIO_REVIEW.md", "audio/", "real-device speaker sample", "Generated source WAVs alone do not count", "VOICE_SOURCE_PROVENANCE_TEMPLATE.md", "voice_source_provenance.yaml", "ARRIVAL_DAY_RUNBOOK.md", "Transcript:", "Hello. I am Stackchan, and I am awake.", "Input received. I am thinking now. Curiosity level rising.", "Small problem found. I can help fix it. Safety first.", "Audition: Warm Slow", "Audition: Bright Robot", "Warmer and slightly slower", "Brighter synthetic pass", "voice/stackchan_spark_greeting.wav", "voice/stackchan_spark_thinking.wav", "voice/stackchan_spark_safety.wav", "voice/stackchan_spark_audition_warm_slow_greeting.wav", "voice/stackchan_spark_audition_bright_robot_greeting.wav", "voice/rvc/RVC_AUDITIONS.md", "voice/rvc/stackchan_rvc_bright_robot.wav", "Arrival-Day Evidence Loop", "RUN_DISPLAY_ONLY.cmd", "RUN_SERVO_CALIBRATION.cmd", "RUN_PROGRESS_CHECK.cmd", "RUN_EVIDENCE_VERIFY.cmd", "RUN_CONSUMER_PROMOTION_CHECK.cmd", "RELEASE_ACCEPTANCE.md", "release_acceptance.json", "GITHUB_ACTIONS_STATUS.md", "github_actions_status.json", "READINESS_REPORT.md", "readiness_report.json", "SHA256SUMS.txt", "stackchan_alive_$Version.zip", "stackchan_alive_$Version.zip.sha256")) {
