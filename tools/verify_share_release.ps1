...
foreach ($pattern in @("Stackchan Share LAN Troubleshooting", "LAN URL Candidates", "Host Reachability Probes", "same Wi-Fi/LAN", "virtual", "Windows Firewall")) {
...
if ($null -ne $status) {
  foreach ($propertyName in @("lanDiagnostics", "hostProbeResults", "lanTroubleshooting", "shareProbeReport")) {
