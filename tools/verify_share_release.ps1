...
$expectedFiles = @(
  ...
  @{ Path = "voice/stackchan_spark_audition_bright_robot_greeting.mp3"; MinBytes = 50000; Type = "audio/" },
  @{ Path = "voice/stackchan_spark_thinking.mp3"; MinBytes = 50000; Type = "audio/" },
  @{ Path = "voice/VOICE_SAMPLES.md"; MinBytes = 100; Type = "" },
  @{ Path = "voice/VOICE_AUDITION.html"; MinBytes = 1000; Type = "text/html" },
  @{ Path = "voice/rvc/README.md"; MinBytes = 400; Type = "" },
  ...
  @{ Path = "ROLLOUT_STATUS.md"; MinBytes = 100; Type = "" },
  @{ Path = "ROLLOUT_STATUS.json"; MinBytes = 100; Type = "" },
...
$retiredRvcIndexPatterns = @(
  "RVC Neutral", "RVC Warm Slow", "RVC Bright Robot Less Static",
  "RVC Bright Robot Sweet Vocoder", "RVC Bright Robot Soft Boops",
  "RVC Spark Boops", "RVC High Character", "stackchan_rvc_neutral.wav",
  "stackchan_rvc_bright_robot_less_static.wav", "stackchan_rvc_safety_neutral.wav",
  "voice/rvc/RVC_AUDITIONS.md", "voice/rvc/stackchan_rvc_bright_robot.wav",
  "voice/rvc/stackchan_rvc_bright_robot_sweet_vocoder.wav",
  "RVC Voice Auditions", "Current Lead: RVC Bright Robot", "Selected settings",
  "pitch 2, index 0.62, RMS mix 0.72, protect 0.28", "RVC MP3 Readme",
  "RVC Local Audition Page", "voice/rvc/RVC_AUDITION.html",
  "voice/rvc/stackchan_rvc_bright_robot.mp3",
  "voice/rvc/stackchan_rvc_thinking_neutral.mp3",
  "voice/rvc/stackchan_rvc_safety_neutral.mp3"
)
foreach ($pattern in @($Version, "Hardware validation is still pending", "No-hardware gates passed", "Hardware gates pending", "Consumer rollout", "GitHub Actions", "Speaker audio evidence", "Next Action", "Next owner:", "Read rollout status", "ROLLOUT_STATUS.md", "ROLLOUT_STATUS.json", "Preflight Evidence", "No-hardware device preflight", "Pending Promotion Gates", "Do not mark this release consumer-ready", "display-only-flash", "speech-mouth-demo-evidence", "servo-calibration", "mixed-mode-soak", "power-cycle-recovery", "target-speaker-audio-evidence", "hardware-evidence-verification", "production-voice-source", "logs/speech_mouth_demo_serial.log with streamed speech envelope commands, speech clear, and completion", "logs/speak_all_intents_serial.log", "USB power-cycle observation marked pass", "completed AUDIO_REVIEW.md plus a real-device speaker recording under audio/", "Dependency Provenance", "Declared library deps", "Direct Git deps missing refs", "Resolved Git deps without SHA", "SCServo#ee6ee4a", "DEPENDENCIES.md", "dependency_lock.json", "stackchan_alive_preview.png", "stackchan_alive_expression_sheet.png", "stackchan_alive_preview.mp4", "stackchan_alive_speech_preview.gif", "Voice Samples", "Stackchan Spark Synth v4", "micro-prosody", "syllable gating", "electromechanical mask", "formant-like resonators", "sample-hold texture", "comb resonance", "light musical vocoder", "phrase-timed chirp/boop accents", "RVC Voice Auditions", "Current Lead: RVC Bright Robot", "Selected settings", "pitch 2, index 0.62, RMS mix 0.72, protect 0.28", "near-final direction", "bright synthetic robot character", "RVC Neutral", "RVC Warm Slow", "RVC Bright Robot", "RVC Bright Robot Less Static", "RVC Bright Robot Sweet Vocoder", "RVC Bright Robot Soft Boops", "RVC Spark Boops", "RVC High Character", "stackchan_rvc_neutral.wav", "stackchan_rvc_bright_robot_less_static.wav", "stackchan_rvc_safety_neutral.wav", "eSpeak-NG", "setup_voice_tools.cmd", "RenderEspeakSamples", "Voice Review Checklist", "Voice Source Gate", "blocked-pending-production-voice-source", "blocked voice-source gates", "VOICE_SOURCE_STATUS.md", "voice_source_status.json", "pending production source", "licensed or owned production voice required", "RVC Candidate Base", "candidate-pending-rights-review", "Weights.gg", "clyaxlb9b000eoiqywl68wcrc", "CA0BFE7A889D81532A449307057718BF83B343BD09D6B69CAF2DFB79450EF9AE", "RVC_VOICE_BASE_STATUS.md", "rvc_voice_base_status.json", "Generated RVC base status", "local archive verified for review cache", "voice_rvc_base.yaml", "voice_rvc_base_metadata.json", "Hardware Audio Evidence", "AUDIO_REVIEW.md", "audio/", "real-device speaker sample", "Generated source WAVs alone do not count", "VOICE_SOURCE_PROVENANCE_TEMPLATE.md", "voice_source_provenance.yaml", "ARRIVAL_DAY_RUNBOOK.md", "Transcript:", "Hello. I am Stackchan, and I am awake.", "Input received. I am thinking now. Curiosity level rising.", "Small problem found. I can help fix it. Safety first.", "Audition: Warm Slow", "Audition: Bright Robot", "Warmer and slightly slower", "Brighter synthetic pass", "Local Voice Audition Page", "voice/VOICE_AUDITION.html", "voice/stackchan_spark_greeting.wav", "voice/stackchan_spark_thinking.wav", "voice/stackchan_spark_thinking.mp3", "voice/stackchan_spark_safety.wav", "voice/stackchan_spark_audition_warm_slow_greeting.wav", "voice/stackchan_spark_audition_bright_robot_greeting.wav", "voice/stackchan_spark_audition_bright_robot_greeting.mp3", "RVC MP3 Readme", "voice/rvc/README.md", "RVC Local Audition Page", "voice/rvc/RVC_AUDITION.html", "voice/rvc/RVC_AUDITIONS.md", "voice/rvc/stackchan_rvc_bright_robot.wav", "voice/rvc/stackchan_rvc_bright_robot.mp3", "voice/rvc/stackchan_rvc_bright_robot_sweet_vocoder.wav", "voice/rvc/stackchan_rvc_thinking_neutral.mp3", "voice/rvc/stackchan_rvc_safety_neutral.mp3", "Arrival-Day Evidence Loop", "RUN_DISPLAY_ONLY.cmd", "RUN_SPEECH_MOUTH_DEMO.cmd", "RUN_SPEAK_ALL_INTENTS.cmd", "speech envelope mouth demo", "RUN_SERVO_CALIBRATION.cmd", "RUN_PROGRESS_CHECK.cmd", "RUN_EVIDENCE_VERIFY.cmd", "RUN_CONSUMER_PROMOTION_CHECK.cmd", "Share Diagnostics", "OPEN_LOCAL_SHARE.cmd", "LAN_TROUBLESHOOTING.md", "share_probe_report.json", "share_status.json", "virtual/VPN adapters", "RELEASE_ACCEPTANCE.md", "release_acceptance.json", "GITHUB_ACTIONS_STATUS.md", "github_actions_status.json", "READINESS_REPORT.md", "readiness_report.json", "SHA256SUMS.txt", "stackchan_alive_$Version.zip", "stackchan_alive_$Version.zip.sha256")) {
  if ($retiredRvcIndexPatterns -contains $pattern) { continue }
...
foreach ($pattern in @("Optional Local RVC", "bring-your-own-model", "RVC BYOM Policy")) {
  if ($indexText -notmatch [regex]::Escape($pattern)) {
    throw "index.html missing RVC BYOM guidance: $pattern"
  }
}
...
$retiredRvcProbePaths = @(
  "voice/rvc/RVC_AUDITION.html",
  "voice/rvc/stackchan_rvc_bright_robot.mp3",
  "voice/rvc/stackchan_rvc_thinking_neutral.mp3",
  "voice/rvc/stackchan_rvc_safety_neutral.mp3",
  "voice/rvc/RVC_AUDITIONS.md", "voice/rvc/RVC_AUDITIONS.json",
  "voice/rvc/stackchan_rvc_neutral.wav", "voice/rvc/stackchan_rvc_warm_slow.wav",
  "voice/rvc/stackchan_rvc_bright_robot.wav", "voice/rvc/stackchan_rvc_bright_robot_less_static.wav",
  "voice/rvc/stackchan_rvc_bright_robot_sweet_vocoder.wav", "voice/rvc/stackchan_rvc_bright_robot_soft_boops.wav",
  "voice/rvc/stackchan_rvc_spark_boops.wav", "voice/rvc/stackchan_rvc_high_character.wav",
  "voice/rvc/stackchan_rvc_thinking_neutral.wav", "voice/rvc/stackchan_rvc_safety_neutral.wav"
)
$probedPaths = @($probedPaths | Where-Object { $retiredRvcProbePaths -notcontains $_ })
if ($hasPreflightReport) {
