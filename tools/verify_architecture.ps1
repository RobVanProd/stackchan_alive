...
Assert-FileContains (Expand-SourcePath "src/main.cpp") "xTaskCreatePinnedToCore\s*\(\s*MotionTask\s*,[^;]*,\s*1\s*\)" "MotionTask must be pinned to Core 1 by default."
Assert-FileContains (Expand-SourcePath "src/main.cpp") "xTaskCreatePinnedToCore\s*\(\s*FaceTask\s*,[^;]*,\s*1\s*\)" "FaceTask must be pinned to Core 1 by default."
