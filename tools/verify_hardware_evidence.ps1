...
Assert-LogContains "logs/display_only_serial.log" "\[control\]\s+command=(mode_listen|event_touch|touch_click_react|button_a_listen|speech_env).*at_ms=\d+" "display bench control telemetry"
