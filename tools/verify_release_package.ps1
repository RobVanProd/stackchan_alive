...
foreach ($pattern in @("CommandMap::fromPhraseId", "CommandMap::fromToken", "CommandMap::map", "GoToSleep", "WakeUp", "LookAtMe", "StopMoving", "HowDoYouFeel", "EventType::IdleTimeout", "EventType::WakeWord", "EventType::FaceDetected", "EventType::ResponseStarted", "hasMotionEnable", "motionEnabled", "command_stop_moving")) {
