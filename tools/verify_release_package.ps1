...
foreach ($pattern in @("BridgeClient::begin", "BridgeClient::submitControlLine", "BridgeClient::poll", "BridgeClientState::Thinking", "BridgeClientOutputType::ResponseStart", "BridgeClientOutputType::AudioFrame", "stackchan.bridge.v1", "parseErrors", "heartbeats")) {
