...
foreach ($pattern in @("verify_hardware_evidence.ps1", "AndroidProbeEvidenceContractSelfTest", "stackchan.android-companion-probe.v1", "stackchan.android-udp-beacon-probe.v1", "stackchan.android-companion-logcat.v1", "schema mismatch", "status is not accepted", "Android probe strict evidence contract verified", "Strict Android probe evidence contract tests passed")) {
