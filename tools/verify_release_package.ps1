...
foreach ($pattern in @("[control] help: status", "motion stop|resume", "servos off|on", "demo off|on", "safe stop|panic", "safe resume|restore", "ambient <lux> <hour>", "time <0-23>", "command <1-5|go_to_sleep|wake_up|look_at_me|stop_moving|how_do_you_feel>", "sound dir=<deg> level=<0.0-1.0>", "noise level=<0.0-1.0>", "touch cheek|forehead", "pickup [strength]", "shake [strength]", "putdown", "tilt <x> <y> <z>", "fillStatus", "fillMotionEnable", "fillDemoEnable", "fillSafeStop", "fillSafeResume", "fillAmbient", "fillCircadian", "fillCommandEvent", "fillAudioEvent", "fillPhysicalEvent", "parsePayloadValue", "parseAzimuthDeg", "PickedUp", "Shaken", "PutDown", "Tilted", "SoundDirection", "LoudNoise", "CommandMap::fromToken", "hasSpeechCue", "speechCue", "event_shaken_hold", "event_put_down_resume", "sound_direction", "loud_noise", "proximity_near", "touch_payload", "parseLux", "parseHour", "wantsStatus", "hasMotionEnable", "motionEnabled", "hasDemoEnable", "demoEnabled", "hasAmbient", "hasCircadian", "status", "telemetry", "health", "reduced on|off", "motion reduced on|off", "reduced_motion_on", "reduced_motion_off", "motion_stop", "motion_resume", "demo_off", "demo_on", "safe_stop", "safe_resume", "ambient_context", "circadian_context", "parseOnOff", "hasReducedMotion")) {
...
foreach ($pattern in @("gFaceControlQueue", "gMotionControlQueue", "FaceControlInput", "MotionControlInput", "publishFaceControl", "publishMotionControl", "applyFaceControlInput", "applyMotionControlInput", "gFace.setReducedMotion", "gIntent.setReducedMotion", "gIntent.queueSpeechCue", "gIntent.applyAmbient", "gIntent.applyCircadian", "gActuation.setEnabled", "gIntent.setDemoEnabled", "gActuation.isEnabled", "gIntent.isDemoEnabled", "gFace.isReducedMotion", "gFace.speechTelemetry", "payload_x=", "payload_y=", "payload_z=", "cue_intent=", "cue_earcon=", "picked_up", "shaken", "put_down", "tilted", "sound_direction", "loud_noise", "printAudioTelemetry", "[audio] event=", "detect_ms=", "frame_ms=", "latency_ms=", "azimuth_deg=", "reduced_motion=", "motion_enabled=", "demo_enabled=", "ambient_lux=", "circadian_hour=", "hour=", "speech_active=", "[runtime]", "[motion] enabled=", "wantsStatus", "printHeartbeat", "printSystemTelemetry", "printRuntimeStatus")) {
