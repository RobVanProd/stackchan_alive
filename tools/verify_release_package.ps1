...
foreach ($pattern in @("BridgeClient::begin", "BridgeClient::update", "BridgeClient::submitControlLine", "BridgeClient::poll", "BridgeClientState::Thinking", "BridgeClientOutputType::ResponseStart", "BridgeClientOutputType::AudioFrame", "stackchan.bridge.v1", "failTimeout", "bridge_timeout", "parseErrors", "timeouts", "heartbeats")) {
