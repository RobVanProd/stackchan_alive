...
foreach ($pattern in @("status", "telemetry", "health", "[heartbeat]", "[system]", "[runtime]", "motion_enabled", "demo_enabled", "speech_active", "camera_ready", "camera_hw", "camera_active", "camera_events", "speech_adapter_ready", "speech_adapter_hw", "speech_cues", "speech_earcons", "audio_out_ready", "audio_out_hw", "audio_out_core0", "audio_out_requests", "audio_out_playing", "audio_out_frames", "audio_out_ducks", "[speech_audio]", "source=packaged_prompt", "prompt_id", "prompt_wav", "prompt_sidecar", "[audio_out]", "duck_on_barge_in", "sidecar_frames", "sidecar_frame_ms", "playback_ms", "media/voice/sidecars", "earcon_samples", "earcon_peak", "earcon_checksum", "speak <boot|idle|attend", "RUN_SPEAK_ALL_INTENTS.cmd", "speak_all_intents_serial.log", "help", "speech clear", "touch cheek", "touch forehead", "proximity 0.85", "pickup 0.80", "shake 1.0", "putdown", "tilt x=0.40 y=-0.20 z=0.90", "sound dir=-45 level=0.70", "noise level=0.90", "[audio] event=", "latency_ms", "azimuth_deg", "payload_x", "payload_y", "payload_z", "ambient 12 22", "ambient lux 700 hour 10", "time 22", "circadian hour 7", "ambient_lux", "circadian_hour", "reduced on", "motion stop", "motion resume", "demo off", "demo on", "safe stop", "panic", "safe resume", "restore", "[motion] enabled=0")) {
...
foreach ($pattern in @("AudioOut::begin", "AudioOut::enqueue", "AudioOut::pollSpeechFrame", "AudioOut::duck", "resolveSidecar", "envelopeForFrame", "visemeForFrame", "requestsQueued", "requestsDropped", "speechFramesEmitted", "duckEvents", "lastSidecarPath", "taskPinnedToCore0")) {
...
foreach ($pattern in @("Stackchan Spark", "must not clone", "soundboard clips", "RVC character models", "licensed neutral TTS voice", "persona/EarconSynth", "io/SpeechAdapter", "io/AudioOut", "mouth-frame streaming", "barge-in ducking", "[speech_audio]", 'typed `SpeechEarcon`', "no allocation", "media/voice/rvc/RVC_AUDITION.html", "open_voice_audition.cmd -Rvc", "open_voice_audition.cmd -All", "Acceptance Criteria")) {
