...
foreach ($pattern in @("share_release.cmd", "DownloadCloudflared", "prepare_device_arrival.cmd", "RUN_DISPLAY_ONLY.cmd", "RUN_SERVO_CALIBRATION.cmd", "-ConfirmServoRisk", "Hardware validation is still required")) {
