...
foreach ($pattern in @("stackchan.hardware-sim.v1", "VirtualStackchanHardware", "MAX_AUDIO_STREAM_CHUNK_BYTES", "AUDIO_DOWNLINK_TEST_BYTES", "audio_stream_chunk_bytes_declared", "audio_stream_chunk_bytes_max", "audio_stream_chunk_too_large", "bridge_downlink_ready", "bridge_downlink_streams", "bridge_downlink_completed", "bridge_downlink_chunks", "bridge_downlink_bytes", "bridge_downlink_errors", "full_audio_downlink_frames", "lan_text_frames", "conversation_rehearsal_frames", "conversation_tts_downlink_frames", "lan_tts_downlink_frames", "conversation_first_audio_latency_ms", "conversation-rehearsal", "conversation-tts-downlink", "arrival_rehearsal_frames", "bridge_kill_recovery_frames", "offline_command_fallback_frames", "offline-command-fallback", "packaged_prompt_requests", "control_input", "power_cycle", "display_frames", "speaker_frames_submitted", "offline_fallback_prompts", "bridge_recoveries", "audio_streams_aborted", "audio_stream_start", "audio_stream_end", "binary_without_audio_stream", "audio_stream_payload_bytes_mismatch", "bridge_timeout", "bridge-kill-recovery", "hardware_simulation.json", "HARDWARE_SIMULATION.md")) {
