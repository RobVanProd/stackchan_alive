...
foreach ($pattern in @("BridgeSocketWriter::begin", "BridgeSocketWriter::queueBinaryFrame", "BridgeSocketWriter::drainPendingFrame", "BridgeSocketWriter::drainPendingTextResponse", "BridgeSocketWriter::nextMaskWord", "BridgeSocketWriter::makeMask", "BridgeSocketWriterDrainResult::Partial", "BridgeSocketWriterDrainResult::NotConnected", "frameBuffered", "binaryFrameQueued", "framesEncoded", "framesWritten", "binaryFramesQueued", "binaryFramesDropped", "binaryFramesEncoded", "binaryFramesWritten", "partialWrites", "writeFailures", "binaryBytesQueued", "binaryBytesWritten", "encodePendingTextResponseFrame", "encodeClientBinaryFrame", "socket_binary_queue_full", "socket_write_failed")) {
...
foreach ($pattern in @("BridgeNetworkSession::begin", "BridgeNetworkSession::start", "BridgeNetworkSession::update", "BridgeNetworkSession::queueBinaryFrame", "BridgeNetworkSession::openSocket", "BridgeNetworkSession::sendHandshake", "BridgeNetworkSession::readHandshake", "BridgeNetworkSession::readConnected", "BridgeNetworkSession::drainWriter", "BridgeNetworkSession::scheduleReconnect", "BridgeNetworkSessionState::Connected", "BridgeWebSocketTransport::buildHandshakeRequest", "transport_.submitBytes", "writer_.drainPendingFrame", "writerBinaryFrames", "tcp_connect_failed", "handshake_timeout", "websocket_closed")) {
...
foreach ($pattern in @("stackchan.bridge.v1", "stackchan.bridge-endpoints.v1", "BridgeEndpointStore", "Preferences backend", "masked client text frame", "drains queued responses through a socket sink", "BridgeNetworkSession", "BridgeWiFiClientSocket", "BridgeWiFiProvisioner", "compile-time Wi-Fi/bridge provisioning", "wake-word gating", "response_start", "audio", "response_end", "character_harness.py", "Accepted", "4096 bytes", "BridgeClientOutput", "downlink consumer", "bridge_downlink_playback_*", "pcm16", "offline matrix", "tools/run_lan_smoke.cmd", "LAN_SMOKE.md/json", "ANDROID_COMPANION_SPEC.md", "active brain owner", "forget_endpoint")) {
