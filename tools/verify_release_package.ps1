...
foreach ($pattern in @("stackchan.android-apk-install.v1", "adb was not found", "Missing Android APK", "devices", "Multiple adb devices", "install", "-r", "dumpsys", "versionName", "versionCode", "android_apk_install.json", "ANDROID_APK_INSTALL.md", "adb_install.log", "adb_dumpsys_package.txt", "-ApkPath", "-Serial")) {
