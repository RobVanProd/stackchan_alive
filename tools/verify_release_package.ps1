...
foreach ($pattern in @("[control] help: status", "motion stop|resume", "servos off|on", "demo off|on", "safe stop|panic", "safe resume|restore", "ambient <lux> <hour>", "time <0-23>", "sound dir=<deg> level=<0.0-1.0>", "noise level=<0.0-1.0>", "touch cheek|forehead", "pickup [strength]", "shake [strength]", "putdown", "tilt <x> <y> <z>", "fillStatus", "fillMotionEnable", "fillDemoEnable", "fillSafeStop", "fillSafeResume", "fillAmbient", "fillCircadian", "fillAudioEvent", "fillPhysicalEvent", "parsePayloadValue", "parseAzimuthDeg", "PickedUp", "Shaken", "PutDown", "Tilted", "SoundDirection", "LoudNoise", "event_shaken_hold", "event_put_down_resume", "sound_direction", "loud_noise", "proximity_near", "touch_payload", "parseLux", "parseHour", "wantsStatus", "hasMotionEnable", "motionEnabled", "hasDemoEnable", "demoEnabled", "hasAmbient", "hasCircadian", "status", "telemetry", "health", "reduced on|off", "motion reduced on|off", "reduced_motion_on", "reduced_motion_off", "motion_stop", "motion_resume", "demo_off", "demo_on", "safe_stop", "safe_resume", "ambient_context", "circadian_context", "parseOnOff", "hasReducedMotion")) {
