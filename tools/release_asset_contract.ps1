...
function Get-ReleaseBaseAssetEntries {
  ...
  $entries = @(
    ...
    New-ReleaseAssetEntry -Name "RVC_AUDITIONS.md" -Path (Join-Path $PackageRoot "media/voice/rvc/RVC_AUDITIONS.md")
    New-ReleaseAssetEntry -Name "RVC_AUDITIONS.json" -Path (Join-Path $PackageRoot "media/voice/rvc/RVC_AUDITIONS.json")
    New-ReleaseAssetEntry -Name "stackchan_rvc_neutral.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_neutral.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_warm_slow.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_warm_slow.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_bright_robot.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_bright_robot.wav")
    ...
    New-ReleaseAssetEntry -Name "stackchan_rvc_bright_robot_less_static.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_bright_robot_less_static.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_bright_robot_sweet_vocoder.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_bright_robot_sweet_vocoder.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_bright_robot_soft_boops.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_bright_robot_soft_boops.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_spark_boops.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_spark_boops.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_high_character.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_high_character.wav")
    New-ReleaseAssetEntry -Name "stackchan_rvc_thinking_neutral.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_thinking_neutral.wav")
    ...
    New-ReleaseAssetEntry -Name "stackchan_rvc_safety_neutral.wav" -Path (Join-Path $PackageRoot "media/voice/rvc/stackchan_rvc_safety_neutral.wav")
