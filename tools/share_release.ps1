...
$preflightDownloadItems
  ...
  <ol>
    ...
    <li>Run <code>RUN_SPEAK_ALL_INTENTS.cmd</code> to capture <code>logs/speak_all_intents_serial.log</code> with every packaged speech intent and audio-output handoff.</li>
