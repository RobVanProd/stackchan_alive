...
- `AWAY_CLOUDFLARE_BRIDGE.md`: independent Home/Away robot profiles, Cloudflare Tunnel and Access setup, secure provisioning, app switching, and acceptance checks.
