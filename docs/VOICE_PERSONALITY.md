...
Quick review MP3s for the current lead, thinking, and safety lines live in `media/voice/rvc/`; open `media/voice/rvc/RVC_AUDITION.html` or run `tools/open_voice_audition.cmd -Rvc` to audition them locally.
