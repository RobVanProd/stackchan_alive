...
- A no-hardware virtual Stackchan simulator checks bridge frame ordering, LAN text turns, speech-envelope handoff, binary TTS audio stream accounting, and timeout failure behavior before the physical unit arrives.
