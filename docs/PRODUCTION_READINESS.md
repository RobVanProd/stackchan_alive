...
- A no-hardware virtual Stackchan simulator checks bridge frame ordering, LAN text turns, speech-envelope handoff, binary TTS audio stream accounting, PCM16 speaker handoff telemetry, and timeout failure behavior before the physical unit arrives.
